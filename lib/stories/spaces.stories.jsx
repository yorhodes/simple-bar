import * as Error from '../components/error.jsx'
import * as Spaces from '../components/spaces/spaces'
...
const Template = function (args) {
  if (args.error) {
    return <Error.Component type="error" />
  } else if (!args.output) {
    return <Error.Component type="noOutput" />
  } else if (typeof args.output != 'object' || !args.output.spaces) {
    return <Error.Component type="noData" />
  }
